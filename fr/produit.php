...
<table width="1" border="0" cellpadding="20" align="left" >
 ...
 <td height="13">
	  <div align="left"><a href="produit_seul.php?num_produit=<? echo $num_produit ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','images/ajouter_over.jpg',1)"><img src="images/ajouter_on.jpg" name="Image6" width="99" height="13" border="0"></a>	   	  </div>
	 </td>
						</tr>
						</table>
					</td>
 ...
 <td height="25">
	  <div align="left"><a href="produit_seul.php?num_produit=<? echo $num_produit ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image7','','images/ajouter_over.jpg',1)"><img src="images/ajouter_on.jpg" name="Image7" width="99" height="13" border="0"></a>	   	  </div>
	 </td>
			        </tr>
			      	</table>
