...
// Modifications tag Public-Idées

$prix_total_ht = $prix_total/1.196;
$num_commande = urlencode($row2["num_commande"]);
...
?>
	<img src="http://tracking.publicidees.com/check.php?comid=78&progid=162&uniqid=<? echo $num_commande; ?>&price=<? echo $prix_total_ht; ?>" width="0" height="0" border="0">
  <tr>
