...
<table id="texte1_blanc" width="359" border="0" cellpadding="15" cellspacing="3" marginleft="0">
...
<table width="352" border="0" align="center" cellpadding="3" cellspacing="0">
        <form action="livre_ajout_2.php" name="formulaire" method="post" onsubmit="return Form1_Validator(this)">
          <tr> 
            <td width="113" colspan="3" valign="top" id="texte1"><p>Nom * <br>
                <input name="nom" type="text" id="nom" size="34">
              </p></font>
              </td>
          </tr>
          <tr> 
            <td id="texte1" width="113" height="21" valign="top">e-mail *<br> 
              <input name="mail" type="text"  size="34"> </font></td>
          </tr>
          <tr valign="top"> 
            <td height="5" colspan="3" valign="top" id="texte1_blanc"><p>Message 
                *:<br>
                <textarea name="message" cols="40" rows="3"></textarea>
              </p></td>
          </tr>
          <tr valign="top"> 
            <td colspan="3" valign="top" id="texte1_blanc"> *champs obligatoires 
              <br> <br> </td>
          </tr>
          <tr> 
