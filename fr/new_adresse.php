  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="15">
    <tr>
      <td><TABLE cellSpacing=2 cellPadding=2 border=0>
          <TR> 
            <TD colspan=4 align=left id="texte3_blanc">Créer une adresse de livraison</TD>
          </TR>
          <TR> 
            <TD colspan=4>&nbsp;</TD>
          </TR>
          ...
          <TR> 
            ...
            <TD colSpan=3><INPUT maxLength=255 size=70 name=adresse1></TD>
          </TR>
          <TR> 
            <TD id="texte2_blanc" noWrap>Adresse (suite) :</TD>
            <TD colSpan=3><INPUT maxLength=255 size=70 name=adresse2></TD>
          </TR>
          <TR> 
