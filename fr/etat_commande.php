...
<table width="100%" border="0" cellspacing="0" cellpadding="15">
  <tr>
	...
	{
?>
      Il n'y a pas de résultats &agrave; votre recherche. 
      <?
	}
	else
	{
?>
      <br>
      <br>
      <table align=left border=1 bordercolor="B9133C" cellpadding=0 cellspacing=0 width=99%>
        <tr bordercolor="B9133C"> 
          <td align=center class="entete_panier" id="texte2_blanc">&nbsp;Numéro commande&nbsp;</td>
          <td align=center class="entete_panier" id="texte2_blanc">&nbsp;Date commande&nbsp;</td>
          <td align=center class="entete_panier" id="texte2_blanc">&nbsp;Mode de paiement&nbsp;</td>
          <td align=center class="entete_panier" id="texte2_blanc">&nbsp;Statut paiement&nbsp;</td>
          <td align=center class="entete_panier" id="texte2_blanc">&nbsp;Statut commande&nbsp;</td>
          <td align=center class="entete_panier" id="texte2_blanc">&nbsp;Commande&nbsp;</td>
			 <td align=center class="entete_panier" id="texte2_blanc">&nbsp;Facture&nbsp;</td>
        </tr>
        <?
	 ...
	 <td height=30 align="center" id=texte2> 
	  ...
	  <?=$row["num_commande"]?>
          ...
          <?
						...
						case 2 :
					?>
          <td align="center" id=texte2><div align="center">envoyée : numéro collisimo : <a href="http://www.coliposte.net/particulier/suivi_particulier.jsp?colispart=<?=$row["num_colissimo"]?>" target="_blank"><b> 
              <?=$row["num_colissimo"]?>
              </b></a></div></td>
          <?
						break;
          ...
          <?
					...
					?>
          <td align=center id=texte2><div align="center"><a href="javascript:MM_openBrWindow('print_commande.php?id=<?=$row["num_commande"]?>','','scrollbars=yes,resizable=yes, width=900,height=600')" >Imprimer</a></div></td>
        	<td align=center id=texte2><div align="center"><a href="javascript:MM_openBrWindow('print_commande_client.php?id=<?=$row["num_commande"]?>','','scrollbars=yes,resizable=yes, width=900,height=600')" >Imprimer</a></div></td>
		  </tr>
        <?
		}
?>
