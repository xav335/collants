...
// selection du client..
$ChaineSQL = "SELECT email, mdp FROM client WHERE email='".$_POST["email"]."' ORDER by num_client DESC";
//echo $ChaineSQL;
...
<TABLE cellSpacing=3 cellPadding=15 border=0>
  ...
  <TR>
  <TD colspan=4 align=left id="texte2_blanc">Vos identifiants et mot de passe vous ont été envoyés par mail.</TD>
  </TR>
</TABLE>
</BODY>
</HTML>
