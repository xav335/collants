...
<body background="../images/fond_collants_large.gif" bgproperties="fixed" id="fond_rose" onLoad="MM_preloadImages('images/supprimer_over.gif','images/passer_commande_over.gif','images/valider_commande_over.gif','images/ajouter_livraison_over.gif')" border="0">
<br>
...
<table width="100%" border="0" align="left" cellpadding="15" >
  ...
  switch (mysql_num_rows($result))
  {
  	...
  	?>
  	<tr>
  		<td id="texte2"><p>Votre adresse de livraison :<br>
          <br>
          <?=$row["civilite"]?>
          <?=$row["prenom_liv"]?>
          <?=$row["nom_liv"]?>
   ...
   <td id="texte2"><a href="new_adresse.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','images/ajouter_livraison_over.gif',1)"><img src="images/ajouter_livraison_on.gif" name="Image1" width="198" height="13" border="0"></a></td>
  	...
  	<tr>
  		<td id="texte2">Veuillez choisir votre mode de paiement</td>
  	</tr>
  	<tr>
  		<td align=left>	
  	...
  	<tr>
  		<td id="texte2">Veuillez choisir votre adresse de livraison</td>
  	</tr>
  	<tr>
  		<td id="texte2">
  	<?
	...
	function afficheDescURL(toThis) 
  	...
  	//-->
  		...
  		<option selected value=0>-- veuillez choisir une adresse --</option>
  		<?
   ...
   <td id="texte2"><a href="new_adresse.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','images/ajouter_livraison_over.gif',1)"><img src="images/ajouter_livraison_on.gif" name="Image2" width="198" height="13" border="0"></a></td>
  	</tr>
   ...
   <td align=left>	
	...
	<input onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','images/valider_over.gif',1)" name="Image4" type="image" src="images/valider_on.gif"  width="108" height="13" border="0" >
  		</td>
  	</tr>
