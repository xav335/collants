...
<body background="../images/fond_collants_large.gif" bgproperties="fixed" id="fond_rose" onLoad="MM_preloadImages('images/envoyer_over.gif')" border="0">
<table width="425" border="0" cellpadding="21" align="left" >
    <td colspan="3" align="left" valign="top" id="texte2"> <p><span id="texte3_blanc">Vous 
        avez oubli&eacute; votre mot de passe ?</span><br>
        <br>
        <strong>Changez-le en 3 &eacute;tapes. </strong><br>
        <br>
        &Eacute;tape 3 :</p>
      <p><br>
        Entrez votre nouveau mot de passe, confirmez-le et cliquez sur &quot;Envoyer&quot;. 
        Pour des raisons de s&eacute;curit&eacute;, nous ne pouvons vous redonner 
        votre ancien mot de passe.<br>
        <br>
        <strong>Nouveau mot de passe : </strong></p>
      <form name="form1" method="post" action="">
        <input type="text" name="textfield">
      </form>
      <p><strong>Confirmez-le : </strong></p>
      <form name="form2" method="post" action="">
        <input type="text" name="textfield2">
      </form>
      <p><br>
        <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','images/envoyer_over.gif',1)"><img src="images/envoyer_on.gif" name="Image3" width="108" height="13" border="0"></a> 
      </p></td>
  </tr>
</table>
</body>
