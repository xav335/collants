...
<table width="100%" border="0" align="left" cellpadding="10" >
    <td colspan="3" align="left" valign="top" id="texte3_blanc">Récapitulatif de votre commande<br><br>
    <?
   ...
   $mon_result_adresse_liv = mysql_query($ChaineSQL);
	...
	?>
	  		...
	  		<td id="texte2"><b>Votre adresse de livraison:</b><br><br>
	  		 ...
	  		 {
	?>
	  		 batiment <?=$row_result_adresse_liv["batiment"]?>,
	<?
			 }
			 if ($row_result_adresse_liv["porte"] != "")
	  		 {
	?>
	  		 porte <?=$row_result_adresse_liv["porte"]?>, 
	<?		 
			 }
	  		 if ($row_result_adresse_liv["etage"] != "")
	  		 {
	?>
	  		 étage <?=$row_result_adresse_liv["etage"]?>
	<?
			 }
	?>
	  		 <br>
