...
<table width="425" border="0" cellpadding="21" align="left" >
    <td colspan="3" align="left" valign="top" id="texte2"> <span id="texte3_blanc">Inscription</span><br> <br> <br>
      <strong>Quelle est votre adresse e-mail ?</strong><br>
      <br>
...
<form name="form1" method="post" action="">
      ...
      <p> <br>
        Cette information est indispensable pour vous permettre d'acc&eacute;der 
        &agrave; nos services.</p>
      <p><br>
        <strong>Avez-vous un mot de passe collants.fr ?</strong></p>
      <form name="form2" method="post" action="">
        <input type="radio" name="radiobutton" value="radiobutton">
        Non, vous &ecirc;tes un nouveau client. <a href="panier_inscritption_nouveau_client.php">POUR 
        XAVIER</a><br>
        <br>
        <input type="radio" name="radiobutton" value="radiobutton">
      ...
      <p><a href="panier_inscritption_vide.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','images/continuer_over.gif',1)"><img src="images/continuer_on.gif" name="Image3" width="99" height="13" border="0"></a><a href="panier_changer_mdp1.php"><br>
        <br>
        - Vous avez oubli&eacute; votre mot de passe ? </a><br>
        <br>
        <a href="panier_changer_mail.php">- Vous avez chang&eacute; d'adresse 
        e-mail depuis votre derni&egrave;re commande ? </a></p>
      </td>
  </tr>
</table>
</body>
