...
<body id="fond_rose" border="0" background="../images/fond_collants_large.gif" bgproperties="fixed">
<table width="425" border="0" cellpadding="21" align="left" >
    <td colspan="3" align="left" valign="top" id="texte2"><strong>pour ___________<br>
      <br>
      (Si vous n'&ecirc;tes pas __________, <a href="panier_inscritption_accueil.php">cliquez 
      ici</a>.) </strong><br>
      <br>
      <br>
      <span id="texte3_blanc">Votre panier est vide pour le moment.</span><br> 
      <br>
      Placez-y tous les articles que vous souhaitez commander. 
      <p><br>
        <span id="texte3_blanc">&Agrave; propos de votre panier </span><br>
        <br>
        Le prix indiqu&eacute; pour chaque article figurant dans votre panier 
        correspond au prix le plus r&eacute;cent mentionn&eacute; sur sa page 
        produit.<br>
        Les articles figurant dans votre panier y sont conserv&eacute;s pendant 
        90 jours. <br>
        Si vous souhaitez utiliser un ch&egrave;que-cadeau ou un bon de r&eacute;duction, 
        le code de ce ch&egrave;que ou de ce bon vous sera demand&eacute; au moment 
        de payer. <br>
      </p>
      <br> <br>
      <p> <br>
