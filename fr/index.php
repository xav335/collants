...
$ChaineSQL = "SELECT titre_bas, lien_photo FROM accueil WHERE num_texte=1";
//echo $ChaineSQL;
...
<body onLoad="runSlideShow1(); runSlideShow2(); runSlideShow3(); runSlideShow4(); runSlideShow5();MM_preloadImages('/images/frenchflag.gif','/images/ukflag.gif')">
        ...
        <td width="980" height="560" align="left" valign="top"><table width="980" height="560" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td>
                          ...
                          <tr align="left" valign="top"> 
                            <td height="140"><table>
                                <tr> 
                                  <td width="153" height="18"><span class="crochet">[</span>&nbsp;<a id="accueil_menu" href="boutique.php?num_rubrique=1">Les collants</a></td>
                                </tr>
                                <tr> 
                                  <td height="18"><span class="crochet">[</span>&nbsp;<a id="accueil_menu" href="boutique.php?num_rubrique=2">Les bas</a></td>
                                </tr>
                                <tr> 
                                  <td height="18"><span class="crochet">[</span>&nbsp;<a id="accueil_menu" href="boutique.php?num_rubrique=3">Nouveautés</a></td>
                                </tr>
                                <tr> 
                                  <td height="18"><span class="crochet">[</span>&nbsp;<a id="accueil_menu" href="promotions.php">Promotions</a></td>
                                </tr>
                                <tr> 
                                  <td height="18"><span class="crochet">[</span>&nbsp;<a id="accueil_menu" href="boutique.php?num_rubrique=4">Coup de c&#339;ur</a></td>
                                </tr>
                                <tr> 
            ...
            <tr> 
              <td id="texte2" height="60" colspan="2"><div align="center">collants.fr 
                    ...
                    40100 dax &#8226; T&eacute;l. +33 (5) 58 74 14 27 &#8226; 
