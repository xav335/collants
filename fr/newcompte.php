...
?>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="15">
		  <tr>
			<td>
			  Votre compte existe déjà dans notre base client.<br> <br>
			  Si vous avez perdu votre mot de passe, <br> <br> <a target=_self href="lost_pass.php">Cliquez 
			  ici</a> pour qu'il vous soit envoyé par email.</td>
		  </tr>
		</table>
		</body>
		</html>
