...
<link href="file:///E|/Collants.fr/Site%20internet%20NEW/fr/include/collants_styles.css" rel="stylesheet" type="text/css">
...
<body background="../images/fond_collants_large.gif" bgproperties="fixed" id="fond_rose" onLoad="MM_preloadImages('images/continuer_over.gif')" border="0">
<table width="425" border="0" cellpadding="21" align="left" >
    <td colspan="3" align="left" valign="top" id="texte2"> <p><span id="texte3_blanc">Changer 
        votre adresse e-mail</span><br>
        <br>
        <strong>Tapez votre ancienne adresse e-mail : </strong></p>
      <form name="form1" method="post" action="">
        <input name="textfield" type="text" size="40">
      </form>
      <p>(Entrez l'adresse e-mail de votre compte collants.fr.) </p>
      <p><strong>Entrez votre mot de passe : </strong></p>
      <form name="form2" method="post" action="">
        <input type="text" name="textfield2">
      </form>
      <p><a href="panier_changer_mdp1.php">Vous avez oubli&eacute; votre mot 
        de passe ? </a></p>
      <p>Votre nouvelle adresse e-mail :</p>
      <form name="form3" method="post" action="">
        <input name="textfield3" type="text" size="40">
      </form>
      <p>(Un message de confirmation vous sera envoy&eacute; &agrave; votre nouvelle 
        adresse e-mail) </p>
      <p><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','images/continuer_over.gif',1)"><img src="images/continuer_on.gif" name="Image3" width="99" height="13" border="0"></a><br>
        <br>
        Si vous avez re&ccedil;u un message d'erreur en utilisant notre serveur 
        s&eacute;curis&eacute;, utilisez le <a href="#">serveur standard. <br>
        </a><br>
      </p>
      </td>
  </tr>
