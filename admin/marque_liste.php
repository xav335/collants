...
<table width="100%" height="100%" border="0" cellpadding="10" cellspacing="0">
  <tr> 
  	<?
		if (!isset($_GET["ordre"])) $_GET["ordre"] = "marque";
		$sql = "SELECT * ";
        $sql .= " FROM marque ";
		$sql .= " WHERE marque.actif=1";
	...
	<? if (mysql_num_rows($result)>0) {?>
    	<td valign="top">
	        ...
	        <tr align="center" > 
				<td class="affichageT" align="left">&nbsp;</td>
	          	<td class="affichageT" align="left"><a class="affichageT" href="marque_liste.php?ordre=num_marque">n°</a></td>
			  	<td class="affichageT" align="left"><a class="affichageT" href="marque_liste.php?ordre=marque">marque</a></td>
				<td class="affichageT" align="left">&nbsp;</td>
	        </tr>
			<? while($row=mysql_fetch_array($result)){ ?>
				...
				?>		
			<tr align="center""> 
			  <td class="<? echo $class_ch?>" align="left"><a href="marque_modif.php?num_marque=<? echo $row["num_marque"]?>"><img src="images/modifier_off.gif" alt="" width="13" height="13" border="0"></a></td>
	          <td class="<? echo $class_ch?>" align="left"><? echo $row["num_marque"]?></td>
			  <td class="<? echo $class_ch?>" align="left"><b><? echo $row["marque"]?></b></td>
			  <td class="<? echo $class_ch?>" align="left"><a href="marque_suppr.php?num_marque=<? echo $row["num_marque"]?>" onclick="return confirm('ATTENTION !! \n êtes-vous sûr de vouloir supprimer la catégorie <? echo $row["marque"] ?> ? \n tous les produit de cette marque seront archivés !')"><img src="images/supprimer_off.gif" alt="" width="13" height="13" border="0"></a></td>
	        </tr>
				<? $cc++ ?>	
			<? }?>
	      	</table>
	  ...
	  <? } else {?>
	  	<td align="center">Pas de marque dans la base</td>
	  <? }?>
  </tr>
</table>
</body>
