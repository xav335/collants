...
<tr>
	<td align="center" valign="middle">
        ...
        <form action="taille_ajout_2.php" method="post" name="formulaire"  onsubmit="return Form1_Validator(this)" enctype="application/x-www-form-urlencoded">
        	<tr>
            		<td align="center" id="texte3">Ajout taille</td>
        	</tr>
        	<tr> 
