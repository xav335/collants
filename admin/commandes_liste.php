...
<!--
	function confirmation(id) {
		if (confirm("Etes vous sur de vouloir supprimer cette commande?")) {
			document.location.href = "suppr_commande.php?id="+id+"&retour=1";
		}
	}
...
<table border=0 cellpadding=0 cellspacing=0 width=100%>
	<tr>
		<td width=10>&nbsp;</td>
		<td align=center><b>Liste des commandes à livrer.</b></td>
		<td width=10>&nbsp;</td>
	</tr>
	<tr>	
		<td colspan=3>&nbsp;</td>
	...
	$ChaineSQL .= " WHERE statut_commande=1 AND (statut_paiement=2 OR statut_paiement=1) ";
	...
	<tr>
		<td width=10>&nbsp;</td>
		<td align=center>il n'y a aucune commande a livrer.</td>
		<td width=10>&nbsp;</td>
	</tr>
	<?
	}
		...
		<tr>
			...
			<table border=1 bordercolor=#000000 cellpadding=0 cellspacing=0 width=90%>
				<tr>
					...
					<td align=center id=texte2 width=70>&nbsp;Statut&nbsp;</td>
					<td align=center id=texte2>&nbsp;Bon de livraison&nbsp;</td>
					<td align=center id=texte2>&nbsp;Fact Compta&nbsp;</td>
					<td align=center id=texte2>&nbsp;Fact Client&nbsp;</td>
					<td align=center id=texte2>&nbsp;Modifier&nbsp;</td>
	...
	?>
				...
				<tr>
					...
					switch($row["statut_paiement"]) {
						case 1 :
					?>
							<td id=texte2 align=center>payé</td>
					<?
						break;
						case 2 :
					?>
						<td id=texte2 align=center>en attente</td>
					<?
						break;
						case 3 :
					?>
						<td id=texte2 align=center>refusé</td>
					<?
						break;
						default : 
					?>
					...
					?>
					<td align=center id=texte2><a href="javascript:MM_openBrWindow('print_bon_livraison.php?id=<?=$row["num_commande"]?>','','scrollbars=yes,resizable=yes, width=900,height=600')" >Imprimer</a></td>
					...
					<td align=center id=texte2><a href="modif_commande.php?id=<?=$row["num_commande"]?>&retour=1">Modifier</a></td>
