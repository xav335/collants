...
$sql = "SELECT * ";
$sql .= " FROM  taille ";
$sql .= " WHERE taille.num_taille=". $_GET["num_taille"];
$result = mysql_query($sql);
$nb_enr = mysql_num_rows($result);
if ($nb_enr>0){
	while ($prod = mysql_fetch_array($result)) { 
		$num_taille = $prod["num_taille"];
		$taille =  $prod["taille"];
		$taille_en =  $prod["taille_en"];
	}
}
?>
...
<tr>
	<td align="center" valign="middle">
        ...
        <form action="taille_modif_2.php" method="post" name="formulaire"  onsubmit="return Form1_Validator(this)" enctype="application/x-www-form-urlencoded">
        	<input type="hidden" name="num_taille" value="<? echo $num_taille?>">
        	<tr>
            		<td align="center" id="texte3">Modification taille</td>
        	</tr>
        	<tr> 
			...
			<tr> 
            	<td> 
	                ...
	                <tr> 
	                  	<td  height="30" id="texte2b"><img src="images/frenchflag.gif" width="18" alt="" border="0">Cat&eacute;gorie :&nbsp;&nbsp;
	                  			<input size="60"  name="taille" type="text" value="<? echo htmlspecialchars($taille)?>"></td>
	                </tr>
	              	</table>
				</td>
          	</tr>
			<tr> 
            	<td> 
					<table width="100%" border="0" cellpadding="2" cellspacing="0">
	                <tr> 
	                  	<td  height="30" id="texte2b"><img src="images/ukflag.gif" width="18" alt="" border="0">Cat&eacute;gorie :&nbsp;&nbsp;
							<input size="60"  name="taille_en" type="text" value="<? echo htmlspecialchars($taille_en)?>"></td>
	                </tr>
	              	</table>
				</td>
          	</tr>
         	<tr> 
          	...
          	<tr> 
            	<td> 
                	...
                	<tr> 
                  		<td align="center"> <input type="button" value="retour à la liste" onclick="javascript:document.location.href='taille_liste.php'"> </td>
