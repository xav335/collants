...
<tr>
	<td align="center" valign="middle">
        ...
        <form action="remise_produit_2.php" method="post" name="formulaire"  onsubmit="return Form1_Validator(this)" >
        	...
        	<tr> 
			 ...
			 <?
				$query="SELECT produit.num_produit,produit.designation, produit_remise.num_remise  FROM produit ";
			...
			?>
          <tr> 
            <td align="center" id="texte3">Produits</td>
          </tr>
          <tr> 
                ...
                <tr> 
                  ...
                  <? while ($cat = mysql_fetch_array($rstemp)) { ?>
                  	<?		
						...
						$query.=" AND num_remise=". $_GET["num_remise"];	
						//echo $query;
