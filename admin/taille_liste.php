...
<table width="100%" height="100%" border="0" cellpadding="10" cellspacing="0">
  <tr> 
  	<?
		if (!isset($_GET["ordre"])) $_GET["ordre"] = "taille";
		$sql = "SELECT * ";
        $sql .= " FROM taille ";
		$sql .= " WHERE  actif = 1 ";
	...
	<? if (mysql_num_rows($result)>0) {?>
    	<td valign="top">
	        ...
	        <tr align="center" > 
				<td class="affichageT" align="left">&nbsp;</td>
	          	<td class="affichageT" align="left"><a class="affichageT" href="taille_liste.php?ordre=num_taille">n°</a></td>
			  	<td class="affichageT" align="left"><a class="affichageT" href="taille_liste.php?ordre=taille">taille</a></td>
				<td class="affichageT" align="left"><a class="affichageT" href="taille_liste.php?ordre=taille_en">taille uk</a></td>
			  	<td class="affichageT" align="left">&nbsp;</td>
	        </tr>
			<? while($row=mysql_fetch_array($result)){ ?>
				...
				?>		
			<tr align="center""> 
			  <td class="<? echo $class_ch?>" align="left"><a href="taille_modif.php?num_taille=<? echo $row["num_taille"]?>"><img src="images/modifier_off.gif" alt="" width="13" height="13" border="0"></a></td>
	          <td class="<? echo $class_ch?>" align="left"><? echo $row["num_taille"]?></td>
			  <td class="<? echo $class_ch?>" align="left"><b><? echo $row["taille"]?></b></td>
			   <td class="<? echo $class_ch?>" align="left"><b><? echo $row["taille_en"]?></b></td>
			  <td class="<? echo $class_ch?>" align="left"><a href="taille_suppr.php?num_taille=<? echo $row["num_taille"]?>" onclick="return confirm('ATTENTION !!!! \n êtes-vous sûr de vouloir supprimer la taille <? echo $row["taille"] ?> ? \n toutes les sous références de produit seront supprimées !!')"><img src="images/supprimer_off.gif" alt="" width="13" height="13" border="0"></a></td>
	        </tr>
				<? $cc++ ?>	
			<? }?>
	      	</table>
	  ...
	  <? } else {?>
	  	<td align="center">Pas de taille dans la base</td>
	  <? }?>
  </tr>
</table>
</body>
