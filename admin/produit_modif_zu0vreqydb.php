			...
			<tr> 
                ...
                <tr> 
                    ...
                    <select name="num_marque" size="1">
                      ...
                      <? } ?>
                      <? } ?>
                    </select> <a href="javascript:wLoader('marque_ajout.php')"><img src="images/modifier_off.gif" alt="" width="13" height="13" border="0"></a> 
                  	</td>	
                  ...
                  <td> <table cellspacing="0" cellpadding="0" border="0">
                      <tr> 
                        <td id="texte2b"><img src="images/frenchflag.gif" width="18" alt="" border="0">Description:<br> <br> 
							...
							?>
                          <textarea cols="50" rows="5" name="description" wrap="soft"><? echo htmlspecialchars($description) ?></textarea> 
                        </td>
                      </tr>
                    </table></td>
                  <td width="15">&nbsp;</td>
                  <td valign="top"> <table cellspacing="0" cellpadding="0" border="0">
                      <tr> 
                        <td id="texte2b"><img src="images/frenchflag.gif" width="18" alt="" border="0">Note:<br> <br> 
							...
							?>
                          <textarea cols="35" rows="5" name="note" wrap="soft"><? echo htmlspecialchars($note) ?></textarea> 
                        </td>
                      </tr>
                    </table></td>
                </tr>
                  ...
                  <td> 
                      ...
                      <tr> 
                        <td id="texte2b"><img src="images/ukflag.gif" width="18" alt="" border="0">Description:<br> <br> 
                          <textarea cols="50" rows="5" name="description_en" wrap="soft"><? echo htmlspecialchars($description_en) ?></textarea> 
                        </td>
                      </tr>
                      </table></td>
                  <td width="15">&nbsp;</td>
                  <td valign="top"> <table cellspacing="0" cellpadding="0" border="0">
                      <tr> 
                        <td id="texte2b"><img src="images/ukflag.gif" width="18" alt="" border="0">Note:<br> <br> 
                          	 <textarea cols="35" rows="5" name="note_en" wrap="soft"><? echo htmlspecialchars($note_en) ?></textarea> 
                        </td>
                      </tr>
                    </table></td>
                </tr>
          ...
          <tr> 
            <td> 
         	...
         	<tr> 
	       	...
	       	<tr> 
	        	<td align="center" id="texte3">Appartenance aux rubriques</td>
	        </tr>
			<?
...
<? include_once("../include/_connexion_fin.php"); ?><!-- MMDW:success -->