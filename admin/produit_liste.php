...
<table width="100%" height="100%" border="0" cellpadding="10" cellspacing="0">
  <tr> 
  	<?
		...
		$sql = "SELECT produit.num_produit, produit.reference,produit.visible, produit.prix, produit.designation, produit.vignette, marque.marque";
    	...
    	<td valign="top">
	        ...
	        <tr align="center" > 
				<td class="affichageT" align="left">&nbsp;</td>
	          	<td class="affichageT" align="left"><a class="affichageT" href="produit_liste.php?ordre=reference">ref</a></td>
			  	<td class="affichageT" align="left"><a class="affichageT" href="produit_liste.php?ordre=designation">designation</a></td>
			  	<td class="affichageT" align="left"><a class="affichageT" href="produit_liste.php?ordre=marque">marque</a></td>
				<td class="affichageT" align="left"><a class="affichageT" href="produit_liste.php?ordre=visible">visible</a></td>
			  	<td class="affichageT" align="left"><a class="affichageT" href="produit_liste.php?ordre=prix">Prix</a></td>
			  	<td class="affichageT" align="left">&nbsp;</td>
	        </tr>
			...
			<tr align="center""> 
			  ...
			  <td class="<? echo $class_ch?>" align="left"><? echo $row["marque"]?></td>
			   <td class="<? echo $class_ch?>" align="left"><? echo $row["visible"]?></td>
			  <td class="<? echo $class_ch?>" align="left"><? echo $row["prix"]?>€</td>
			  <td class="<? echo $class_ch?>" align="left"><a href="produit_suppr.php?num_produit=<? echo $row["num_produit"]?>" onclick="return confirm('êtes-vous sûr de vouloir supprimer la référence <? echo $row["reference"] ?> ?')"><img src="images/supprimer_off.gif" alt="" width="13" height="13" border="0"></a></td>
	        </tr>
				<? $cc++ ?>	
			<? }?>
	      	</table>
