...
<table width="100%" height="100%" border="0" cellpadding="10" cellspacing="0">
  <tr> 
  	<?
		if (!isset($_GET["ordre"])) $_GET["ordre"] = "couleur";
		$sql = "SELECT * ";
        $sql .= " FROM couleur ";
		$sql .= " WHERE  actif = 1 ";
	...
	<? if (mysql_num_rows($result)>0) {?>
    	<td valign="top">
	        ...
	        <tr align="center" > 
				<td class="affichageT" align="left">&nbsp;</td>
	          	<td class="affichageT" align="left"><a class="affichageT" href="couleur_liste.php?ordre=num_couleur">n°</a></td>
			  	<td class="affichageT" align="left"><a class="affichageT" href="couleur_liste.php?ordre=couleur">couleur</a></td>
				<td class="affichageT" align="left"><a class="affichageT" href="couleur_liste.php?ordre=couleur_en">couleur uk</a></td>
			  	<td class="affichageT" align="left">&nbsp;</td>
				<td class="affichageT" align="left">&nbsp;</td>
	        </tr>
			<? while($row=mysql_fetch_array($result)){ ?>
				...
				?>		
			<tr align="center""> 
			  <td class="<? echo $class_ch?>" align="left"><a href="couleur_modif.php?num_couleur=<? echo $row["num_couleur"]?>"><img src="images/modifier_off.gif" alt="" width="13" height="13" border="0"></a></td>
	          <td class="<? echo $class_ch?>" align="left"><? echo $row["num_couleur"]?></td>
			  <td class="<? echo $class_ch?>" align="left"><b><? echo $row["couleur"]?></b></td>
			   <td class="<? echo $class_ch?>" align="left"><b><? echo $row["couleur_en"]?></b></td>
			   <td class="<? echo $class_ch?>" align="left"><img width=30 src="/couleur/<? echo $row["fic_couleur"] ?>"  alt=""  border="0"></td>
			  <td class="<? echo $class_ch?>" align="left"><a href="couleur_suppr.php?num_couleur=<? echo $row["num_couleur"]?>" onclick="return confirm('ATTENTION !!!! \n êtes-vous sûr de vouloir supprimer la couleur <? echo $row["couleur"] ?> ? \n toutes les sous références de produit seront supprimées !!')"><img src="images/supprimer_off.gif" alt="" width="13" height="13" border="0"></a></td>
	        </tr>
				<? $cc++ ?>	
			<? }?>
	      	</table>
	  ...
	  <? } else {?>
	  	<td align="center">Pas de couleur dans la base</td>
	  <? }?>
  </tr>
</table>
</body>
