...
<tr>
	<td align="center"> <table width="980" height="560" border="0"  cellpadding="0" cellspacing="0" background="images/admin3.gif" id="border1">
        <tr> 
          <td height="560" align="left" valign="top"> <table width="100%" height="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr> 
                <td width="163" height="560" align="left" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="5">
                    <tr> 
                      ...
                      <td width="100%" height="560" align="left" valign="top"> 
                        <table width="177" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr> 
                            <td height="25" align="left" valign="top" id="texte2_rouge">Gestion 
                              Produits</td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td height="25" align="left" valign="top"><a id="menu" href="collants.htm"><span id="crochet_menu">[</span> 
                              Commandes</a></td>
                          </tr>
                          <tr> 
                            <td height="25" align="left" valign="top"><a id="menu" href="collants.htm"><span id="crochet_menu">[</span> 
                          ...
                          <tr> 
                            <td height="25" align="left" valign="top"><a id="menu" href="mailto:marcus@ruhrmann.fr"><span id="crochet_menu">[</span> 
                              Deconnexion </a></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table></td>
                <td width="91%" align="left" valign="top"> <table width="688" height="523" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                    ...
                    <tr> 
                      <td width="636" height="474" align="left" valign="top"> 
                        <iframe src="admin_colori.htm" id="border1" name="produit" scrolling="auto" height="100%"  width="100%" marginleft="0"  topmargin="0" align="top" valign="left" frameborder="0" ></iframe> 
                      </td>
                    </tr>
                  </table></td>
              </tr>
...
oCMenu.makeMenu('top0','','<span ID="crochet_menu">[</span>&nbsp;Produit','collants.htm','produit','150','19','','','','','bottom')	
	oCMenu.makeMenu('sub00','top0','&nbsp;ajouter','','produit','146')
  	oCMenu.makeMenu('sub01','top0','&nbsp;modifier','','produit','146')
 	oCMenu.makeMenu('sub02','top0','&nbsp;supprimer','','produit','146')
	oCMenu.makeMenu('sub03','top0','&nbsp;ajouter une sous-référence','','produit','146')
 	oCMenu.makeMenu('sub04','top0','&nbsp;modifier une référence','','produit','146')		
	oCMenu.makeMenu('sub05','top0','&nbsp;associer aux catégories','produit_categorie.php','produit','146')						

oCMenu.makeMenu('top1','','<span ID="crochet_menu">[</span>&nbsp;Marque','','_top','150','19','','')	
	oCMenu.makeMenu('sub10','top1','&nbsp;ajouter','','produit','146')
  	oCMenu.makeMenu('sub11','top1','&nbsp;modifier','','produit','146')
 	oCMenu.makeMenu('sub12','top1','&nbsp;supprimer','','produit','146')

oCMenu.makeMenu('top2','','<span ID="crochet_menu">[</span>&nbsp;Couleur','','_top','150','19','','')	
	oCMenu.makeMenu('sub20','top2','&nbsp;ajouter','','produit','146')
  	oCMenu.makeMenu('sub21','top2','&nbsp;modifier','','produit','146')
 	oCMenu.makeMenu('sub22','top2','&nbsp;supprimer','','produit','146')
	
oCMenu.makeMenu('top3','','<span ID="crochet_menu">[</span>&nbsp;Taille','','_top','150','19','','')	
	oCMenu.makeMenu('sub30','top3','&nbsp;ajouter','','produit','146')
  	oCMenu.makeMenu('sub31','top3','&nbsp;modifier','','produit','146')
 	oCMenu.makeMenu('sub32','top3','&nbsp;supprimer','','produit','146')
	
oCMenu.makeMenu('top4','','<span ID="crochet_menu">[</span>&nbsp;Catégorie','','_top','150','19','','')	
	oCMenu.makeMenu('sub40','top4','&nbsp;ajouter','','produit','146')
  	oCMenu.makeMenu('sub41','top4','&nbsp;modifier','','produit','146')
 	oCMenu.makeMenu('sub42','top4','&nbsp;supprimer','','produit','146')
