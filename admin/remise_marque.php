...
<tr>
	<td align="center" valign="middle">
        ...
        <form action="remise_marque_2.php" method="post" name="formulaire"  onsubmit="return Form1_Validator(this)" >
        	<input type="hidden" name="num_remise" value="<? echo $_GET["num_remise"] ?>">
			...
			?>
          <tr> 
            <td align="center" id="texte3">MARQUES</td>
          </tr>
          <tr> 
            <td align="center"> <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr> 
                  ...
                  <? while ($cat = mysql_fetch_array($rstemp)) { ?>
                  	<?		
						$num_marque = $cat["num_marque"];
						
						$marque =  $cat["marque"];
						
					?>
					
                  	<td id="texte2b"><? echo $marque ?>:</td>
						
						<td><input type="checkbox" name="num_marque_<? echo $cpt_col ?>" value="<? echo $num_marque ?>"></td>
          	...
          	<tr> 
            	<td> 
                	...
                	<tr> 
                  		<td align="center"> <input type="button" value="retour" onclick="javascript:document.location.href='remise_liste_pourcentage.php'"> </td>
