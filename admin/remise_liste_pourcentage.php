	...
	<? if (mysql_num_rows($result)>0) {?>
    	<td valign="top">
			...
			<? if ($_GET["action"]=="marque") {?>
				<td class="<? echo $class_ch?>" align="left"><a href="remise_marque.php?num_remise=<? echo $row["num_remise"]?>"><img src="images/modifier_off.gif" alt="" width="13" height="13" border="0"></a></td>
			<? } else {?>	
				<td class="<? echo $class_ch?>" align="left"><a href="remise_produit.php?num_remise=<? echo $row["num_remise"]?>"><img src="images/modifier_off.gif" alt="" width="13" height="13" border="0"></a></td>
	        <? }?>   	
