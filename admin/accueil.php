...
oCMenu.makeMenu('top0','','<span ID="crochet_menu">[</span>&nbsp;Produit','','produit','150','19','','','','','bottom')	
	...
	oCMenu.makeMenu('sub01','top0','&nbsp;liste complète','<?=$chemin?>admin/produit_liste.php','produit','146')
	...
	oCMenu.makeMenu('sub04','top0','&nbsp;sous-référence par produit','<?=$chemin?>admin/sousref_liste_produit.php','produit','146')
	oCMenu.makeMenu('sub05','top0','&nbsp;liste des &nbsp;sous-référence','<?=$chemin?>admin/sousref_liste.php','produit','146')
	oCMenu.makeMenu('sub06','top0','&nbsp;Produits associés','<?=$chemin?>admin/produit_liste_filtre.php?action=association','produit','146')
	oCMenu.makeMenu('sub07','top0','&nbsp;Thèmes produits','<?=$chemin?>admin/gestion_theme.php','produit','146')
...
oCMenu.makeMenu('top6','','<span ID="crochet_menu">[</span>&nbsp;Commandes','','_top','150','19','','')	
	oCMenu.makeMenu('sub60','top6','&nbsp;Commandes à livrer','<?=$chemin?>admin/commandes_liste.php','produit','146')
  oCMenu.makeMenu('sub61','top6','&nbsp;Commandes livrées','<?=$chemin?>admin/commandes_livrees.php','produit','146')	
  oCMenu.makeMenu('sub62','top6','&nbsp;Commandes refusées','<?=$chemin?>admin/commandes_refusee.php','produit','146')	
