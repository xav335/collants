...
oCMenu.onlineRoot="/collants4/admin/" 
...
oCMenu.makeMenu('top0','','<span ID="crochet_menu">[</span>&nbsp;Produit','','produit','150','19','','','','','bottom')	
	oCMenu.makeMenu('sub00','top0','&nbsp;ajouter un produit','produit_ajout.php','produit','146')
  	oCMenu.makeMenu('sub01','top0','&nbsp;liste complète','produit_liste.php','produit','146')
	oCMenu.makeMenu('sub02','top0','&nbsp;promotions','produit_liste_filtre.php?action=promotion','produit','146')
	oCMenu.makeMenu('sub03','top0','&nbsp;top 5','produit_liste_filtre.php?action=top5','produit','146')
	oCMenu.makeMenu('sub04','top0','&nbsp;sous-référence par produit','sousref_liste_produit.php','produit','146')
	oCMenu.makeMenu('sub05','top0','&nbsp;liste des &nbsp;sous-référence','sousref_liste.php','produit','146')
	oCMenu.makeMenu('sub06','top0','&nbsp;Produits associés','produit_liste_filtre.php?action=association','produit','146')
	
oCMenu.makeMenu('top1','','<span ID="crochet_menu">[</span>&nbsp;Marque','','_top','150','19','','')	
	oCMenu.makeMenu('sub10','top1','&nbsp;ajouter','marque_ajout.php','produit','146')
  	oCMenu.makeMenu('sub11','top1','&nbsp;modifier/supprimer','marque_liste.php','produit','146')

oCMenu.makeMenu('top2','','<span ID="crochet_menu">[</span>&nbsp;Couleur','','_top','150','19','','')	
	oCMenu.makeMenu('sub20','top2','&nbsp;ajouter','couleur_ajout.php','produit','146')
  	oCMenu.makeMenu('sub21','top2','&nbsp;modifier/supprimer','couleur_liste.php','produit','146')
	
oCMenu.makeMenu('top3','','<span ID="crochet_menu">[</span>&nbsp;Taille','','_top','150','19','','')	
	oCMenu.makeMenu('sub30','top3','&nbsp;ajouter','taille_ajout.php','produit','146')
  	oCMenu.makeMenu('sub31','top3','&nbsp;modifier/supprimer','taille_liste.php','produit','146')
	
oCMenu.makeMenu('top4','','<span ID="crochet_menu">[</span>&nbsp;Catégorie','','_top','150','19','','')	
	oCMenu.makeMenu('sub40','top4','&nbsp;ajouter','categorie_ajout.php','produit','146')
  	oCMenu.makeMenu('sub41','top4','&nbsp;modifier/supprimer','categorie_liste.php','produit','146')


oCMenu.makeMenu('top5','','<span ID="crochet_menu">[</span>&nbsp;Clients','clients_liste.php','produit','150','19','','')	

oCMenu.makeMenu('top6','','<span ID="crochet_menu">[</span>&nbsp;Commandes','','_top','150','19','','')	
	oCMenu.makeMenu('sub60','top6','&nbsp;Commandes à livrer','commandes_liste.php','produit','146')
  	oCMenu.makeMenu('sub61','top6','&nbsp;Commandes livrées','commandes_livrees.php','produit','146')	
  	oCMenu.makeMenu('sub62','top6','&nbsp;Commandes refusées','commandes_refusee.php','produit','146')	
	
oCMenu.makeMenu('top7','','<span ID="crochet_menu">[</span>&nbsp;Remises - Port','','_top','150','19','','')	
	oCMenu.makeMenu('sub70','top7','&nbsp;Ajout Codes Remises','remise_ajout.php','produit','146')
	oCMenu.makeMenu('sub71','top7','&nbsp;Codes Remises','remise_liste.php','produit','146')
	oCMenu.makeMenu('sub72','top7','&nbsp;Remises / produit','remise_liste_pourcentage.php','produit','146')
	oCMenu.makeMenu('sub73','top7','&nbsp;Frais de port','frais_de_port.php','produit','146')
	
oCMenu.makeMenu('top8','','<span ID="crochet_menu">[</span>&nbsp;Liens partenaires','','_top','150','19','','')	
	oCMenu.makeMenu('sub80','top8','&nbsp;ajouter','liens_ajout.php','produit','146')
  	oCMenu.makeMenu('sub81','top8','&nbsp;modifier/supprimer','liens_liste.php','produit','146')	

oCMenu.makeMenu('top9','','<span ID="crochet_menu">[</span>&nbsp;Newsletter','','_top','150','19','','')	
	oCMenu.makeMenu('sub90','top9','&nbsp;ajouter','liensout.php','produit','146')
  	oCMenu.makeMenu('sub91','top9','&nbsp;modifier/supprimer','lienliste.php','produit','146')	
...
oCMenu.makeMenu('top11','','<span ID="crochet_menu">[</span>&nbsp;Livre Or','','_top','150','19','','')	
	oCMenu.makeMenu('sub110','top11','&nbsp;liste','livre_or_liste.php','produit','146')
