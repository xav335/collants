...
oCMenu.makeMenu('top0','','<span ID="crochet_menu">[</span>&nbsp;Produit','','produit','150','19','','','','','bottom')	
	oCMenu.makeMenu('sub00','top0','&nbsp;ajouter','produit_ajout.php','produit','146')
  	oCMenu.makeMenu('sub01','top0','&nbsp;modifier/supprimer','produit_liste.php','produit','146')
 	oCMenu.makeMenu('sub02','top0','&nbsp;ajouter une sous-référence','','produit','146')
	oCMenu.makeMenu('sub03','top0','&nbsp;modifier/supprimer une &nbsp;sous-référence','','produit','146','32')
