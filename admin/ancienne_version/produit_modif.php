...
<?
$sql = "SELECT produit.num_produit, produit.reference, produit.prix, produit.designation, produit.vignette,";
$sql .= " produit.num_marque,produit.photo,produit.description,produit.note ";
$sql .= " FROM produit ";
...
<form action="produit_modif_2.php" method="get" name="formulaire"  onsubmit="return Form1_Validator(this)" enctype="multipart/form-data">
...
<tr> 	
	<td align="center" id="texte3_blanc">------------------ Appartenance aux rubriques ------------------</td>	   	   	
</tr>
<tr> 	
	<td align="center">
		...
		<tr>
			<td width="25%">
				...
				<tr>
					...
					<td><input type="checkbox" name="num_rubrique" value="1"></td>
				</tr>
				</table>
			</td>	
			<td width="25%">
				...
				<tr>
					...
					<td><input type="checkbox" name="num_rubrique" value="2"></td>
				</tr>
				</table>
			</td>	
			<td width="25%">
				...
				<tr>
					...
					<td><input type="checkbox" name="num_rubrique" value="3"></td>
				</tr>
				</table>
			</td>	
			<td width="25%">
				<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					<td id="texte2b">Nouveauté:</td>
					<td><input type="checkbox" name="num_rubrique" value="4"></td>
				</tr>
				</table>
			</td>	
		</tr>
...
<tr> 	
	<td align="center" id="texte3_blanc">----------------------------------------------------------------------</td>	   	   	
</tr>
<?
...
?>
<tr> 	
	<td align="center" id="texte3_blanc">------------------ Catégories ------------------</td>	   	   	
</tr>
<? if ($nb_enr>0){?>
<tr> 	
	<td align="center">
		...
		<tr>
			...
			<? while ($cat = mysql_fetch_array($rstemp)) { ?>
				...
				?>
						...
						<td><input type="checkbox" name="num_categorie" value="<? echo $num_categorie ?>"></td>
						<td width="23">&nbsp;</td>
					<? if ($cpt_col%4 ==0) {?> 
						</tr>
						<tr>
...
<tr> 	
	<td>
		...
		<tr>
			...
			<td align="center">
				<input type="submit" name="vvv" value="Valider">
			</td>	
		</tr>
		</table>	
	</td>	   	   	
