...
<tr>
	<td align="center">
		<table width="980" height="560" border="0"  cellpadding="0" cellspacing="0" background="images/login.gif" id="border1">
		  <tr>
		    <td align="left" valign="middle"> <table width="177" height="42" border="0" align="center" cellpadding="2" cellspacing="0">
		       <? if ($_GET["ident"]==1) {?>
			    <tr>
		        ...
		        <tr> <form name="formulaire" method="post" action="identification.php">
