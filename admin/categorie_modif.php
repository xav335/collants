...
$sql = "SELECT * ";
$sql .= " FROM  categorie ";
$sql .= " WHERE categorie.num_categorie=". $_GET["num_categorie"];
$result = mysql_query($sql);
$nb_enr = mysql_num_rows($result);
if ($nb_enr>0){
	while ($prod = mysql_fetch_array($result)) { 
		$num_categorie = $prod["num_categorie"];
		$categorie =  $prod["categorie"];
		$categorie_en =  $prod["categorie_en"];
	}
}
?>
...
<tr>
	<td align="center" valign="middle">
        ...
        <form action="categorie_modif_2.php" method="post" name="formulaire"  onsubmit="return Form1_Validator(this)" enctype="application/x-www-form-urlencoded">
        	<input type="hidden" name="num_categorie" value="<? echo $num_categorie?>">
        	<tr>
            		<td align="center" id="texte3">Modification Categorie</td>
        	</tr>
        	<tr> 
