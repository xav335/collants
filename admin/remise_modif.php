...
$sql = "SELECT * ";
$sql .= " FROM  remise ";
$sql .= " WHERE remise.num_remise=". $_GET["num_remise"];
...
function Form1_Validator(theForm){
	...
	if (theForm.bon_achat.value !=""){
		if (!est_reel(theForm.bon_achat.value)){
			alert("Veuillez indiquez un format de prix valide");
	   		theForm.bon_achat.focus();
	    	return (false);
		}
		if (theForm.minimum_commande.value==""){
			alert("Veuillez indiquez la commande minimum");
	   		theForm.minimum_commande.focus();
	    	return (false);
		}
	}
	   
		if (!est_reel(theForm.minimum_commande.value)){
			alert("Veuillez indiquez un format de commande minimum valide");
	   		theForm.minimum_commande.focus();
	    	return (false);
		}
	
		if (!est_reel(theForm.pourcentage.value)){
...
<tr>
	<td align="center">
        ...
        <form action="remise_modif_2.php" method="post" name="formulaire"  onsubmit="return Form1_Validator(this)">
        	<input type="hidden" name="num_remise" value="<? echo $num_remise?>">
						...
						<td> 
							...
							<tr> 
								<td  height="30" id="texte2b">Bon d'achat :&nbsp;&nbsp;<br>
									<input size="6" name="bon_achat" type="text" value="<? echo $bon_achat?>">€
								</td>
							</tr>
							</table>
						</td>
						...
						<td> 
							...
							<tr> 
								<td  height="30" id="texte2b">Minimum d'achat :&nbsp;&nbsp;<br>
									<input size="6" name="minimum_commande" type="text" value="<? echo $minimum_commande?>">€
								</td>
							</tr>
							</table>
						</td>
						...
						<td> 
							...
							<tr> 
								<td  height="30" id="texte2b">Remise en % :&nbsp;&nbsp;<br>
									<input size="6" name="pourcentage" type="text" value="<? echo $pourcentage?>">%
								</td>
							</tr>
							</table>
						</td>
