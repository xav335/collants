        ...
        <form action="produit_ajout_2.php" method="post" name="formulaire"  onsubmit="return Form1_Validator(this)" enctype="multipart/form-data">
        	...
        	<tr> 
            	<td> 
					<table width="100%" border="0" cellpadding="2" cellspacing="0">
	                <tr> 
	                  	<td width="26%" height="30" id="texte2b"><img src="..//admin/images/frenchflag.gif" width="18" alt="" border="0"> Désignation :&nbsp;&nbsp;<input size="60"  name="designation" type="text" value="<? echo htmlspecialchars($designation)?>"></td>
	                </tr>
	              	</table>
				</td>
          	</tr>
			<tr> 
            	<td> 
					<table width="100%" border="0" cellpadding="2" cellspacing="0">
	                <tr> 
	                  	<td width="26%" height="30" id="texte2b"><img src="..//admin/images/ukflag.gif" width="18" alt="" border="0"> Désignation :&nbsp;&nbsp;<input size="60"  name="designation_en" type="text" value="<? echo htmlspecialchars($designation_en)?>"></td>
	                </tr>
	              	</table>
				</td>
          	</tr>
          ...
          <tr> 
			...
			?>
          <tr> 
            <td align="center" id="texte3">Catégories </td>
          </tr>
          <tr> 
			...
			<tr> 
	            <td> 
					<table width="100%" border="0" cellpadding="2" cellspacing="0">
	                <tr>
	                  <td width="64%" height="30" id="texte2b"><img src="..//admin/images/frenchflag.gif" width="18" alt="" border="0">Libéllé Promotion :&nbsp;&nbsp;<input size="40"  name="lib_lot" type="text" value="<? echo htmlspecialchars($lib_lot)?>"></td>
	                </tr>
	              </table>
				</td>
          	</tr>
			<tr> 
	            <td> 
					<table width="100%" border="0" cellpadding="2" cellspacing="0">
	                <tr>
	                  <td width="64%" height="30" id="texte2b"><img src="..//admin/images/ukflag.gif" width="18" alt="" border="0">Libéllé Promotion :&nbsp;&nbsp;<input size="40"  name="lib_lot_en" type="text" value="<? echo htmlspecialchars($lib_lot_en)?>"></td>
	                </tr>
	              </table>
				</td>
          	</tr>
