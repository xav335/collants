...
<tr>
	<td align="center">
        ...
        <form action="accueil_texte_2.php" method="post" name="formulaire"  onsubmit="return Form1_Validator(this)">
			<tr> 
				...
				<td>
					...
					<tr> 
						<td> 
							...
							<tr> 
								<td  height="30" id="texte2b">Texte Accueil :</td>
							</tr>
							</table>
						</td>
          			</tr>
				...
				<td>
					...
					<tr> 
						<td> 
							<table width="100%" border="0" cellpadding="2" cellspacing="0">
							<tr> 
								<td  height="30" id="texte2b">Titre Bas :</td>
							</tr>
							</table>
						</td>
          			</tr>
