...
<table width="100%" height="100%" border="0" cellpadding="10" cellspacing="0">
  <tr> 
  	<?
		if (!isset($_GET["ordre"])) $_GET["ordre"] = "categorie";
		$sql = "SELECT * ";
        $sql .= " FROM categorie ";
	...
	<? if (mysql_num_rows($result)>0) {?>
    	<td valign="top">
	        ...
	        <tr align="center" > 
				<td class="affichageT" align="left">&nbsp;</td>
	          	<td class="affichageT" align="left"><a class="affichageT" href="categorie_liste.php?ordre=num_categorie">n°</a></td>
			  	<td class="affichageT" align="left"><a class="affichageT" href="categorie_liste.php?ordre=categorie">categorie</a></td>
				<td class="affichageT" align="left"><a class="affichageT" href="categorie_liste.php?ordre=categorie_en">categorie uk</a></td>
			  	<td class="affichageT" align="left">&nbsp;</td>
	        </tr>
			<? while($row=mysql_fetch_array($result)){ ?>
				...
				?>		
			<tr align="center""> 
			  <td class="<? echo $class_ch?>" align="left"><a href="categorie_modif.php?num_categorie=<? echo $row["num_categorie"]?>"><img src="images/modifier_off.gif" alt="" width="13" height="13" border="0"></a></td>
	          <td class="<? echo $class_ch?>" align="left"><? echo $row["num_categorie"]?></td>
			  <td class="<? echo $class_ch?>" align="left"><b><? echo $row["categorie"]?></b></td>
			   <td class="<? echo $class_ch?>" align="left"><b><? echo $row["categorie_en"]?></b></td>
			  <td class="<? echo $class_ch?>" align="left"><a href="categorie_suppr.php?num_categorie=<? echo $row["num_categorie"]?>" onclick="return confirm('êtes-vous sûr de vouloir supprimer la catégorie <? echo $row["categorie"] ?> ?')"><img src="images/supprimer_off.gif" alt="" width="13" height="13" border="0"></a></td>
	        </tr>
				<? $cc++ ?>	
			<? }?>
	      	</table>
	  ...
	  <? } else {?>
	  	<td align="center">Pas de categorie dans la base</td>
	  <? }?>
  </tr>
</table>
</body>
