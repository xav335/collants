...
<tr>
	<td align="center" valign="middle">
        ...
        <form action="categorie_ajout_2.php" method="post" name="formulaire"  onsubmit="return Form1_Validator(this)" enctype="application/x-www-form-urlencoded">
        	<tr>
            		<td align="center" id="texte3">Ajout Categorie</td>
        	</tr>
        	<tr> 
            	...
            	<td> 
	                ...
	                <tr> 
	                  	<td  height="30" id="texte2b"><img src="images/frenchflag.gif" width="18" alt="" border="0">Cat&eacute;gorie :&nbsp;&nbsp;
	                  			<input size="60"  name="categorie" type="text" value="<? echo htmlspecialchars($categorie)?>"></td>
	                </tr>
	              	</table>
				</td>
          	</tr>
            	...
            	<td> 
	                ...
	                <tr> 
	                  	<td  height="30" id="texte2b"><img src="images/ukflag.gif" width="18" alt="" border="0">Cat&eacute;gorie :&nbsp;&nbsp;
							<input size="60"  name="categorie_en" type="text" value="<? echo htmlspecialchars($categorie_en)?>"></td>
	                </tr>
	              	</table>
				</td>
          	</tr>
         	<tr> 
          	...
          	<tr> 
            	<td> 
                	...
                	<tr> 
                  		<td align="center"> <input type="button" value="retour à la liste" onclick="javascript:document.location.href='categorie_liste.php'"> </td>
