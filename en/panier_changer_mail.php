...
<table width="425" border="0" cellpadding="21" align="left" >
    ...
    <td colspan="3" align="left" valign="top" id="texte2"> <p>Change your address 
        e-mail<br>
        <br>
        <strong>Type your old address e-mail:: </strong></p>
      ...
      <p>(Enter the address e-mail of your account collants.fr.)</p>
      ...
      <p><a href="panier_changer_mdp1.php">You forgot your password?</a></p>

      <p>Your new address e-mail:</p>
      ...
      <p>(a message of confirmation will be sent to you at your new address e-mail)) 
      </p>
      ...
      <p><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','images/continuer_over.gif',1)"><img src="images/continuer_on.gif" name="Image3" width="99" height="13" border="0"></a><br>
        <br>
        If you received an error message by using our safe server, use the <a href="#">standard 
        server. <br>
        </a><br>
      </p>
