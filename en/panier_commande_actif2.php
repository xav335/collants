		...
		<? if ($nb_enr>=1){ ?>
			 <form name="formulaire" method="GET" action="panier_commande_actif.php"  onsubmit="return Form1_Validator(this)">  
				...
				<tr align="left" valign="middle">
				  ...
				  <td height="30" class="entete_panier">Colori</td>
				...
				<input name="Recalculer" type="submit" value="Recalculer"><br>
				code remise : <input name="remise" type="text" size="30">&nbsp;&nbsp;<input name="Recalculer" type="submit" value="Valider">
				</form>
				
				<a href="boutique.php?num_rubrique=1" target="_parent">Continuer vos achats</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="commande_1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','images/passer_commande_over.gif',1)"><img src="images/passer_commande_on.gif" name="Image6" width="200" height="26" border="0"></a>
				...
				<? if ($nb_enr>0){?>
					<img src="images/pixel_rouge.jpg" width="100%" height="1">
						<br>
						Les internautes ayant achet&eacute; les m&ecirc;mes articles ont &eacute;galement achet&eacute; : <br>
