  ...
  <td>
   <table width="100%" border="0" cellpadding="10" cellspacing="0">
	...
	&nbsp;
	  ...
	  <br>
	  	   To receive your order, print this form and send it with 
        your payment by cheque to the following adress : <br>
	  <br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="15">
 <tr>
  <td id="texte2">Here is the summary of your order : </td>
 </tr>
</table>
<form name="formul1" method=POST action="enreg_commande.php" onsubmit="return VerifForm()">
 <table width="100%" border="0" align="left" cellpadding="10" >
  <tr>
    <td align="left" valign="top" id="texte3_blanc">Order n°<?=$row2["num_commande"]?></td>
  </tr>
  <tr>
            ...
            <td height="30" class="entete_panier">Total Price/&euro;</td>
				...
				<?  if ($row2["remise"] >0) { ?>
					<tr align="left" valign="top"> 
					  ...
					  ?>
					  <td colspan=3 bgcolor="#FFFFFF" id="texte2_rouge">Purchase coupon <? echo number_format($row2["remise"], 2, ',', ' ')  ?>€</td>
				...
				<?  if ($row2["cadeau"] <>"") { ?>
					<tr align="left" valign="top"> 
					  <td bgcolor="#FFFFFF">&nbsp;</td>
					  <td bgcolor="#FFFFFF">&nbsp;</td>
					  <td colspan="3" bgcolor="#FFFFFF" id="texte2_rouge">Gift : <? echo $row2["cadeau"] ?></td>
					  <td bgcolor="#FFFFFF">&nbsp;</td>
					</tr>
				<? } ?>
				<tr align="left" valign="top"> 
				...
				<tr align="left" valign="top"> 
				  ...
				  <td bgcolor="#FFFFFF">&nbsp;</td>
				  <td bgcolor="#FFFFFF">&nbsp;</td>
				  <td colspan="2" bgcolor="#FFFFFF"><b>Delivery costs</b></td>
	...
	case 2: // cb en ligne
		...
		switch($_GET["etat"])
		{
			case 1 :
				...
				?>
				<tr>
  					<td id="texte2"><b>Your payment was accepted by our bank. You will receive 
        your order as soon as possible. Thank you to have chosen collants.fr</b>
  					</td>
  				</tr>
				<?
			...
			case 2 :
				...
				*/
				?>
				<tr>
  					<td id="texte2"><b>Your payment was not accepted by our bank.</b><b<br>
  					</td>
  				</tr>
				<?
