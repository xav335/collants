...
<form name="formul1" method="post" target="_self" action="commande_2.php" onsubmit="return VerifForm();">
   ...
   <td align="left" valign="top" id="texte2_blanc">Password:</td>
	...
	<div align="left">
	 ...
	 <input name="Image1" type="image" id="Image1" onMouseOver="MM_swapImage('Image1','','images/identification_over.gif',1)" onMouseOut="MM_swapImgRestore()" src="images/identification_on.gif"  width="108" height="13" border="0" >
          <a href="lost_pass.php" target="_self" onMouseOver="MM_swapImage('Image2','','images/mdpperdu_on.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="images/mdpperdu_over.gif" name="Image2" width="170" height="13" border="0"></a>	</div>
   </td>
		</tr>
		<tr>
   ...
   <td colspan=2>&nbsp;</td>
      ...
      <td colspan=2><img src="file:///E|/Collants.fr/collants/www/images/pixel_rouge.jpg" width="100%" height="1"></td>
		</tr>
		<tr>
   ...
   <td colspan=2 align="left" valign="top" id="texte3_blanc"> <a href="creer_compte.php" target="_self" onMouseOver="MM_swapImage('Image3','','images/creer_compte_over.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="images/creer_compte_on.gif" name="Image3" width="170" height="13" border="0"></a>	</td>
		</tr>
	</table>
</form>
</body>
