  ...
  <td>
   <TABLE cellSpacing=2 cellPadding=2 border=0>
    ...
    <TR>
	 ...
	 <TD colspan=4 align=left id="texte3_blanc">Modify an address of delivery</TD>
	</TR>
    ...
    <TR>
	 ...
	 <TD id="texte2_blanc">Surname (*):</TD>
	 <TD>
	  <INPUT maxLength=50 name=nom value="<?=$row["nom_liv"]?>">
	 </TD>
	 <TD id="texte2_blanc">First name (*):</TD>
	 <TD>
	  <INPUT maxLength=50 name=prenom value="<?=$row["prenom_liv"]?>">
	 </TD>
	</TR>
    ...
    <TR>
	 ...
	 <TD>
	  <INPUT maxLength=4 size=4 name=batiment value="<?=$row["batiment"]?>">
	 </TD>
	 <TD id="texte2_blanc">Stage:</TD>
	 <TD>
	  <INPUT maxLength=4 size=4 name=etage value="<?=$row["etage"]?>">
	 </TD>
	</TR>
    ...
    <TR>
	 ...
	 <TD colSpan=3>
	  <INPUT maxLength=4 size=4 name=numporte value="<?=$row["porte"]?>">
	 </TD>
	</TR>
    ...
    <TR>
	 ...
	 <TD colSpan=3>
	  <INPUT maxLength=255 size=50 name=adresse1 value="<?=$row["adresse1"]?>">
	 </TD>
	</TR>
    ...
    <TR>
	 ...
	 <TD id="texte2_blanc" noWrap>Address (continuation):</TD>
	 <TD colSpan=3>
	  <INPUT maxLength=255 size=50 name=adresse2 value="<?=$row["adresse2"]?>">
	 </TD>
	</TR>
    ...
    <TR>
	 ...
	 <TD>
	  <INPUT maxLength=50 name=cp value="<?=$row["cp"]?>">
	 </TD>
	 <TD id="texte2_blanc">City (*):</TD>
	 <TD>
	  <INPUT maxLength=50 name=ville value="<?=$row["ville"]?>">
	 </TD>
	</TR>
	 <TR>
    ...
    <TR>
	 ...
	 <TD>
	  <INPUT maxLength=255 name=email value="<?=$row["email"]?>">
	 </TD>
	 <TD id="texte2_blanc">Telephone :</TD>
	 <TD>
	  <INPUT maxLength=20 name=tel value="<?=$row["tel"]?>">
	 </TD>
	</TR>
    ...
    <TR>
	 ...
	 <TD>
	  <INPUT maxLength=20 name=fax value="<?=$row["fax"]?>">
	 </TD>
	 <TD id="texte2_blanc" noWrap>Mobile:</TD>
	 <TD>
	  <INPUT maxLength=20 name=gsm value="<?=$row["gsm"]?>">
	 </TD>
	</TR>
    ...
    <TR>
	 ...
	 <TD id="texte1" colSpan=4>(*) Obligatory fields.</TD>
	</TR>
