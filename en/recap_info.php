...
<body background="file:///E|/Collants.fr/collants/www/images/fond_collants_large.gif"  leftmargin="15" topmargin="15" bgproperties="fixed" id="fond_rose" onLoad="MM_preloadImages('images/supprimer_over.gif','images/passer_commande_over.gif','images/ajouter_livraison_over.gif','images/suivi_commande_over.gif','images/modifier_adresse_over.gif')" border="0">
<table width="100%" border="0" cellspacing="0" cellpadding="15">
  
 <tr>
    
  <td width="68%" id="texte2_blanc"><b>Hello
   <?=$row["civilite"]?>
      &nbsp;
 ...
 <tr>
  ...
  <td ID="texte2"><b>Here are your personal informations : </b><br>
      <br>
       <b>Delivery main address: </b><br>
...
?>
      <br>
      <br>
      <b>Other delivery addresses: </b><br>
   <br>
...
?>
 ...
 <tr>
  ...
  <td><img src="file:///E|/Collants.fr/collants/www/images/pixel_rouge.jpg" width="100%" height="1"></td>
  <td>&nbsp;</td>
 </tr>
