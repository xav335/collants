...
$ChaineSQL.= " VALUES ('".session_id()."','".$_SESSION["num_client"]."','".$_POST["choix_adresse"]."','".$bon_achat_affichage."','".$cadeau."','".$frais_port."','".Date("Y-m-d")."','".Date("H:i:s")."','".$_POST["mode_paiement"]."','2','1','','') ";
