...
<?
	$prix_total = 0;
	$query  ="SELECT panier.quantite, produit.designation, produit.prix, panier.quantite, couleur.couleur_en, taille.taille_en, ";
	$query .=" couleur.num_couleur, produit.num_produit, produit_sousref.num_produit_sousref, ";
	$query .=" produit.lot, produit.promo_lot, produit.lib_lot_en, panier.num_panier";//,produit_remise.num_remise ";	
	$query .=" FROM  panier ";
	$query .=" INNER JOIN produit_sousref ON panier.num_produit_sousref=produit_sousref.num_produit_sousref";	
	$query .=" INNER JOIN produit ON produit.num_produit=produit_sousref.num_produit";	
	$query .=" INNER JOIN couleur ON couleur.num_couleur=produit_sousref.num_couleur";	
...
<body background="../images/fond_collants_large.gif" bgproperties="fixed" id="fond_rose" onLoad="MM_preloadImages('images/supprimer_over.gif','images/passer_commande_over.gif','images/continuer_achats_over.gif')" border="0">
<table width="100%" border="0" align="left" cellpadding="10" >
    <td colspan="3" align="left" valign="top" id="texte3_blanc">Articles in your basket for an immediate purchase<br>
      	<br>
    	<br>
		<? if ($nb_enr>=1){ ?>
			 <form name="formulaire" method="GET" action="panier_commande_actif.php"  onsubmit="return Form1_Validator(this)">  
				...
				<tr align="left" valign="middle">
				  ...
				  <td height="30" class="entete_panier">Color</td>
				  ...
				  <td height="30" class="entete_panier">Cancel</td>
				</tr>
				...
				<tr align="left" valign="top"><? //echo $row["lot"] ."  ". $row["quantite"] ?> 
				  ...
				  <td bgcolor="#FFFFFF"><b><? echo $row["taille_en"] ?></b></td>
				  <td bgcolor="#FFFFFF"><b><? echo $row["couleur_en"] ?></b></td>
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="1">
	<tr>
	 ...
	 <td align="right">&nbsp;&nbsp;&nbsp;<a href="commande_1.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image61','','images/passer_commande_over.gif',1)"><img src="images/passer_commande_on.gif" name="Image61" width="200" height="26" border="0" id="Image61"></a>
   ...
   <p>The Net surfers having bought as same the following products:</p>
