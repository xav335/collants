    ...
    <form name="formulaire" method="get" action="produit_seul.php#enbas" onSubmit="return validtaille()">  
		...
		<tr> 
          <td valign="top">
              ...
              <tr> 
                <td height="30" colspan="2"  id="texte1_blanc"><a href="produit_photo.php?num_produit=<? echo $num_produit ?>&avant=produit_seul">Click here to enlarge the photograph</a></td>
              </tr>
            </table>
			</td>
        </tr>
		...
		<?
				$query  =" SELECT DISTINCT produit_sousref.num_produit,produit_sousref.num_couleur,couleur.couleur_en,couleur.fic_couleur ";
		...
		<tr>
				...
				<? if ($_GET["num_couleur"]<>"" || $cpt_couleur<=1){
					...
					<tr> 
					  <td height="30" valign="top"  id="texte2"><br>
						...
						(if you have douts about your size, <a href="#" onClick="javascript:wLoader('taille.php?num_marque=<?php echo $num_marque ?>');return false;">click  
						here.</a>)<br>
						<br>
					  </td>
					</tr>
					...
					<tr> 
						<?
							$query  =" SELECT DISTINCT produit_sousref.num_produit,produit_sousref.stock,produit_sousref.num_taille,taille.taille_en ";
							$query .=" FROM  produit_sousref ";
		 ...
		 <? }else{ //ya plus de stock !?>	
			<tr> <td id="texte2">We are sold out ! contact us <a href="contact.php" target="_parent">contact@collants.fr</a></td>
